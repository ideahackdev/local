											...
											?>
															...
															<div class="portfolio200_shadow">
																<a title="<?php echo $portfolio_item->post_title; ?>" href="<?php echo $permalink_url; ?>">
																	<img src="<?php echo get_stylesheet_directory_uri(); ?>/timthumb.php?src=<?php echo $image_url[0]?>&amp;h=<?php echo $pp_portfolio_image_height; ?>&amp;w=200&amp;zc=1" alt="" class="img_nofade frame" width="200" height="<?php echo $pp_portfolio_image_height; ?>"/>
																</a>
																<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon_zoom.png" style="margin-top:-30px;margin-left:85px;z-index:9999"/>
															</div>
															...
															<div class="portfolio200_shadow">
																...
																<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon_play.png" style="margin-top:-30px;margin-left:85px;z-index:9999"/>
															</div>
							        ...
							        <object width="601" height="338" data="http://vimeo.com/moogaloop.swf?clip_id=<?php echo $portfolio_video_id; ?>&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=ffffff&amp;fullscreen=1" type="application/x-shockwave-flash">
			  				    		...
			  				    		<param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id=<?php echo $portfolio_video_id; ?>&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=ffffff&amp;fullscreen=1" />
															...
															?>
																...
																<div class="portfolio_desc" style="width:200px;margin-top:20px;margin-left:10px">
