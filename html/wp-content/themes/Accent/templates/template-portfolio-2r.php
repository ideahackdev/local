...
?>	
						...
						?>
								<div class="portfolio-content section content clearfix" style="width:690px;margin-top:10px;">
											...
											?>
															<div data-id="post-<?php echo $key+1; ?>" class="<?php echo $portfolio_item_set; ?> project" data-type="<?php echo $portfolio_item_set; ?>" style="width:228px;float:left;margin-bottom:40px;">
