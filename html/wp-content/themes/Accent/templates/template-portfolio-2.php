...
?>	
						...
						?>
								<div class="portfolio-content section content clearfix" style="width:640px;margin-top:10px;">
											<?php
											...
											?>
															<div data-id="post-<?php echo $key+1; ?>" class="<?php echo $portfolio_item_set; ?> project" data-type="<?php echo $portfolio_item_set; ?>" style="width:213px;float:left;margin-bottom:40px;">
															...
															<div class="portfolio180_shadow">
																<a title="<?php echo $portfolio_item->post_title; ?>" href="<?php echo $permalink_url; ?>">
																	<img src="<?php echo get_stylesheet_directory_uri(); ?>/timthumb.php?src=<?php echo $image_url[0]?>&amp;h=<?php echo $pp_portfolio_image_height; ?>&amp;w=180&amp;zc=1" alt="" class="img_nofade frame" width="180" height="<?php echo $pp_portfolio_image_height; ?>"/>
																</a>
																<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon_zoom.png" style="margin-top:-30px;margin-left:70px;z-index:9999"/>
															</div>
															...
															<div class="portfolio180_shadow">
																...
																<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icon_play.png" style="margin-top:-30px;margin-left:70px;z-index:9999"/>
															</div>
