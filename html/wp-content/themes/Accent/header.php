...
<?php    
	...
	wp_enqueue_style("pp_theme_style", get_stylesheet_directory_uri()."/css/fullwidth.css", false, $pp_theme_version, "all");
?>
...
#footer, #copyright { background-color: <?php echo $pp_header_bg; ?>; }
...
<?php
	$pp_caption_margintop_size = get_option('pp_caption_margintop_size');
	
	if(!empty($pp_caption_margintop_size))
	{
?>
.caption_desc { margin-top:<?php echo $pp_caption_margintop_size; ?>px; }
<?php
	}
...
<?php
	...
	{
		$pp_button_bg_color_light = '#'.hex_lighter(substr($pp_button_bg_color, 1), 100);
?>
		...
		<div id="top_bg">
			<div id="top_bar">
				...
				<form action="<?php echo get_stylesheet_directory_uri(); ?>/option.php" method="get" id="form_option" name="form_option">
					...
					<div class="inner">
						<strong>Header & Footer Color</strong><br/>
						...
						<strong>Background Pattern:</strong><br/>	
							<select name="pp_bg_pattern" id="pp_bg_pattern" style="margin-top:5px">
								...
								<option value="right_strip2" <?php if($pp_bg_pattern == 'right_strip2') { ?>selected=selected<?php } ?>>Right Strip2</option>
								<option value="left_strip" <?php if($pp_bg_pattern == 'left_strip') { ?>selected=selected<?php } ?>>Left Strip</option>
								<option value="left_strip2" <?php if($pp_bg_pattern == 'left_strip2') { ?>selected=selected<?php } ?>>Left Strip2</option>
								...
								<option value="paper" <?php if($pp_bg_pattern == 'paper') { ?>selected=selected<?php } ?>>Paper</option>
