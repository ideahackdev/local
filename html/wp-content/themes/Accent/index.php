...
get_header(); ?>		
		...
		?>
			...
			<script>$j('body.home #header_wrapper').css('height', '460px');</script>
		...
		<!-- End header -->
			...
			<div id="slider_wrapper" <?php if($pp_slider_effect=='video') { ?>style="height:515px"<?php } ?> <?php if($pp_slider_effect=='roundabout') { ?>style="margin-top:-290px;height:480px"<?php } ?> <?php if($pp_slider_effect=='jQuery') { ?>style="background:none;margin-top:-347px"<?php } ?>>
				...
				<?php
						switch($pp_slider_effect)
						{
							...
							case 'roundabout':
								include (TEMPLATEPATH . "/templates/template-slider-roundabout.php");
							break;
							
							case 'video':
								$pp_slider_video_embedded = get_option('pp_slider_video_embedded');
								echo '<div style="width:960px;height:400px;margin:auto;background:#000">';
				...
				<div class="standard_wrapper small">
					...
					<div class="tagline">
					    <div class="tagline_inner">
					    	<blockquote><?php echo html_entity_decode(stripcslashes($pp_homepage_tagline)); ?></blockquote>
					    </div>
					    <br class="clear"/>
					</div>
