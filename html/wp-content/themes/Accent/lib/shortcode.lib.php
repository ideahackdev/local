...
function home_portfolios_func($atts, $content) {
	...
	foreach($recent_portfolios_arr as $key => $recent_portfolio)
	{
		...
		switch($portfolio_type)
		{
			case 'External Link':
			default:
				$return_html.= '<div class="portfolio3_shadow">';
				$return_html.= '<a title="'.$recent_portfolio->post_title.'" href="'.$permalink_url.'"><img src="'.get_stylesheet_directory_uri().'/timthumb.php?src='.$image_url[0].'&amp;h=131&amp;w=210&amp;zc=1" alt="" class="frame" width="210" height="131"/></a><img src="'.get_stylesheet_directory_uri().'/images/icon_zoom.png" style="margin-top:-30px;margin-left:86px;z-index:9999"/>';
				$return_html.= '</div>';
			break;
			// end external link
			...
			case 'Image':
				$return_html.= '<div class="portfolio3_shadow">';
				$return_html.= '<a title="'.$recent_portfolio->post_title.'" href="'.$image_url[0].'" class="img_frame"><img src="'.get_stylesheet_directory_uri().'/timthumb.php?src='.$image_url[0].'&amp;h=131&amp;w=210&amp;zc=1" alt="" class="frame" width="210" height="131"/></a><img src="'.get_stylesheet_directory_uri().'/images/icon_zoom.png" style="margin-top:-30px;margin-left:86px;z-index:9999"/>';
				$return_html.= '</div>';
			break;
			// end image
			...
			case 'Youtube Video':
				$return_html.= '<div class="portfolio3_shadow">';
				$return_html.= '<a title="'.$recent_portfolio->post_title.'" href="#video_'.$portfolio_video_id.'" class="lightbox_youtube"><img src="'.get_stylesheet_directory_uri().'/timthumb.php?src='.$image_url[0].'&amp;h=131&amp;w=210&amp;zc=1" alt="" class="frame" width="210" height="131"/></a><img src="'.get_stylesheet_directory_uri().'/images/icon_play.png" style="margin-top:-30px;margin-left:86px;z-index:9999"/>';
				$return_html.= '</div>';
				
				$return_html.= '<div style="display:none;">
							    <div id="video_'.$portfolio_video_id.'" style="width:640px;height:385px">
							        
							        <object type="application/x-shockwave-flash" data="http://www.youtube.com/v/'.$portfolio_video_id.'" style="width:640px;height:385px">
		...
		$return_html.= '<div class="portfolio_desc" style="width:200px;margin-top:10px"><strong>'.$recent_portfolio->post_title.'</strong><br/><span>'.pp_substr(strip_tags(strip_shortcodes($recent_portfolio->post_content)), 70).'</span></div>';
