...
array( "name" => "Footer Logo",
	"desc" => "Choose an image that you want to use as the logo in footer",
...
array( "name" => "Top right content",
	"desc" => "Enter content for top right of every page",
	"id" => $shortname."_top_right_content",
	"type" => "textarea",
	"std" => "Follow us @ipeerapong | Call now +66 867055180",
),
...
array( "name" => "Page caption description margin top (in pixels)",
	"desc" => "",
	"id" => $shortname."_caption_margintop_size",
	"type" => "jslider",
	"size" => "40px",
	"std" => "15",
	"from" => 0,
...
array( "name" => "Header and Footer Background Color",
	"desc" => "Select color for the Header and Footer (default #333a3d)",
...
array( "name" => "Menu Font Color",
	"desc" => "Select color for the menu font (default #7f7f7f)",
...
array( "name" => "Button Background Color",
	"desc" => "Select color for the button background (default #ebebeb)",
...
array( "name" => "Button Font Color",
	"desc" => "Select color for the button font (default #888888)",
...
array( "name" => "Button Border Color",
	"desc" => "Select color for the button border (default #ebebeb)",
...
array( "name" => "Embedded Video (size 960x400px)",
...
array( "name" => "Portfolio styles",
	...
	"options" => array(
		...
		'f2' => '<div style="float:left;width:50px;height:40px" class="pp_checkbox_wrapper"><img src="'.get_bloginfo( 'stylesheet_directory' ).'/functions/images/f_width_2cols.png"/></div>',
	),
),
...
array( "name" => "Gallery styles",
	"desc" => "Select the style for the gallery",
	"id" => $shortname."_gallery_style",
	"type" => "select",
	"options" => array(
		'4' => '4 Columns',
		'galleria' => 'Galleria',
