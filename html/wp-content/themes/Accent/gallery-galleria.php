...
?>	
						...
						?>
							<div id="galleria" style="margin-top:-10px">
											<?php
											...
											?>
														<a href="<?php echo $image_url[0]?>">
															<img src="<?php echo get_stylesheet_directory_uri(); ?>/timthumb.php?src=<?php echo $image_url[0]?>&h=80&w=120&zc=1" alt="<?php echo $portfolio_item->post_title?>"/>
														</a>
