<?php
	...
	<li><a href="#"><img src="'.get_bloginfo('template_url').'/images/footer-icon.gif" alt="Facebook Page" /></a></li>
						...
						array(
							...
							'default' => '<p>Fler Template - a ThemeForest exclusive by <a href="http://themeforest.net/user/DDStudios/">DDStudios</a> and <a href="http://themeforest.net/user/lukk/">Lukk</a>.</p>
